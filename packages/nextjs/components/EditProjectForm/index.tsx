...
*/
  ...
  return (
    <FormContext.Provider value={{ setValue, errors, watch, control }}>
      <form onSubmit={handleSubmit(onSubmit, onError)} className="w-8/12 mx-auto p-4 bg-white shadow-md rounded-md">
        ...
        <CheckRadioBox type={"radio"} label={"Cofounder Needed"} options={yesNoOptionList} name={"cofounderNeeded"} />

        <CheckRadioBox
          type={"radio"}
          label={"Accepts Service for Equity"}
