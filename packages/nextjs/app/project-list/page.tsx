...
import {IProject, ServiceType} from "~~/models";
...
const PROJECT_LIST_MOCK: IProject[] = [
    {
        ...
        serviceNeeds: [
            { serviceType: ServiceType.Development, description: 'Full-stack development', equityOffered: 10 },
        ],
        team: [
    ...
    },
    {
        ...
        serviceNeeds: [
            { serviceType: ServiceType.Marketing, description: 'Brand strategy', equityOffered: 5 },
        ],
        team: [
    ...
    },
    {
        ...
        acceptsServiceForEquity: true,
        serviceNeeds: [
            { serviceType: ServiceType.Design, description: 'UI/UX design', equityOffered: 7 },
        ],
        team: [
    ...
    },
    {
        ...
        acceptsServiceForEquity: true,
        serviceNeeds: [
            {  serviceType: ServiceType.Development, description: 'AI development', equityOffered: 15 },
        ],
        team: [
    ...
    },
    {
        ...
        acceptsServiceForEquity: true,
        serviceNeeds: [
            { serviceType: ServiceType.Design, description: 'App design', equityOffered: 12 },
        ],
        team: [
            { uid: 'u123', displayName: 'Alice Smith', photoUrl: 'https://example.com/alice.jpg' },
        ],
